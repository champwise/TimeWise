...
// funtion to change the background coulour to the clicked colour
function clickColor(hexcode, r, g, b){
...
function passwordsMatch(password1, password2){
    ...
    if(password1 == password2  ||  $('#password').val() == ''  ||  $('#password2').val() == ''){
